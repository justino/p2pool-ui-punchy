    ...
    tooltip: {
      formatter: function () {
        ...
        $.each(this.points, function (i, point) {
          ...
          if (point.y > Math.pow(1000, 4)) { val = (point.y / Math.pow(1000, 4)).toFixed(2) + ' TH/s'; }
          else if (point.y > Math.pow(1000, 3)) { val = (point.y / Math.pow(1000, 3)).toFixed(2) + ' GH/s'; }
          else if (point.y > Math.pow(1000, 2)) { val = (point.y / Math.pow(1000, 2)).toFixed(2) + ' MH/s'; }
          else if (point.y > Math.pow(1000, 1)) { val = (point.y / Math.pow(1000, 1)).toFixed(2) + ' KH/s'; }
